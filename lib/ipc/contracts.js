 ...
 * @typedef {{ noteId: string, vaultId: string, noteSnapshot?: object | null, permanent?: boolean }} NoteDeleteRequest
 * @typedef {{ name: string, options?: object, rootPath?: string }} VaultCreateRequest
