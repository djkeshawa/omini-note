// Thin HTTP client for a local Ollama server. No streaming yet — we wait
// for the full response. Uses Node's built-in fetch (Electron 33 → Node 20).
...
module.exports = { ping, tags, embed, generate, chat, DEFAULT_HOST, getHost, setHost };
