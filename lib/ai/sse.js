// onChunk, when given, is called every time bytes arrive — the transport uses
// it to re-arm its idle timer so an actively streaming generation is never
// cut off mid-answer by a total-duration cap.
async function readSseData(response, onData, onChunk) {
