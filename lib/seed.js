...
const SEED_VAULTS = [
  ...
  {
    name: 'Work',
    tags: [{ name: 'project', hue: 210 }, { name: 'meeting', hue: 340 }],
    notes: [{
      id: 'w1', title: 'Welcome to Work',
      date: new Date().toISOString(), tags: [], pinned: true,
      body: '# Work vault\n- Keep company-related notes here\n- Create a new note with ⌘N',
    }],
  },
  {
    name: 'Research',
    tags: [{ name: 'paper', hue: 280 }, { name: 'idea', hue: 60 }],
    notes: [{
      id: 'r1', title: 'Reading list',
