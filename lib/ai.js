...
function toolPlannerSystemPrompt() {
  return [
    ...
    'Decide whether to answer directly, inspect note context, ask a clarifying question, or call tools.',
    'Answer directly when the user asks a general question and no note/app tool is needed.',
    'Use the provided tools to answer questions about notes, perform app actions, inspect notes, edit the current page, and navigate the app.',
