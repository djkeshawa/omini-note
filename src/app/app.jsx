...
import { MN_FONTS, MN_THEMES, mnShadow, mnThemeColorScheme } from '../shared/theme.jsx';
...
function MnApp() {
  ...
  useEffectA(() => {
    ...
    root.style.colorScheme = mnThemeColorScheme(T);
  ...
  const { filteredNotes, searchStatus } = useSearchController({
    query,
    activeVaultId,
    notes: notesWithBody,
    dirtyNotes,
