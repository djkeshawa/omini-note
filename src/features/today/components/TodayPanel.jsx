  ...
  return (
    <main
      ...
      <div style={{ maxWidth: 920, margin: '0 auto' }}>
        <h1 style={{ margin: 0, fontFamily: 'var(--mn-ui)', fontSize: 26, fontWeight: 700, color: T.ink }}>Today</h1>
        <div style={{
          fontFamily: 'var(--mn-body)', fontSize: 14, color: T.inkDim, marginTop: 3, marginBottom: 18,
        }}>{formattedToday}</div>
