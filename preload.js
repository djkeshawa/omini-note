...
contextBridge.exposeInMainWorld('mn', {
  ...
  deleteNote: (vaultId, noteId, noteSnapshot, options) => ipcRenderer.invoke(NOTES_VAULTS_CHANNELS.noteDelete, {
    vaultId,
    noteId,
    noteSnapshot,
    options,
  ...
  saveCanvas: (vaultId, canvas, options) => ipcRenderer.invoke('mn:saveCanvas', vaultId, canvas, options),
  deleteCanvas: (vaultId, canvasId, options) => ipcRenderer.invoke('mn:deleteCanvas', vaultId, canvasId, options),
